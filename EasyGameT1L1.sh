...
echo -e "${CYAN} Easy Game YouTube Channel:${NC} ${WHITE}https://www.youtube.com/@Chinmay_Joshi-CJ/videos${NC}"
...
echo -e "\n${MAGENTA}===============================================================${NC}"
echo -e "${CYAN}   Don't forget to Like, Share, and Subscribe!                 ${NC}"
echo -e "${WHITE} 💸 Easy Game - https://www.youtube.com/@Chinmay_Joshi-CJ/videos${NC}"
echo -e "${MAGENTA}===============================================================${NC}"